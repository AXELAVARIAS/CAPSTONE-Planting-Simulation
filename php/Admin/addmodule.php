    ...
    <div class="d-flex">
        <div class="container p-5">
            ...
            <form action="addmodule.php" method="POST" enctype="multipart/form-data" class="p-5 form-container">
                <h2 class="fs-3 mb-4 text-white"><i class="bi bi-plus-circle"></i> Add New Module</h2>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control mb-3" id="content" name="content" placeholder="https://example.com/content or ../html/modulefiles/Module1.html" required>
